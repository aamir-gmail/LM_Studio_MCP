...
dot = Digraph(comment='USDA Organization Structure')

# Set the direction to left-to-right (LR) for horizontal layout as requested
dot.attr(rankdir='LR')
...
print("File saved as usda_organization.png")