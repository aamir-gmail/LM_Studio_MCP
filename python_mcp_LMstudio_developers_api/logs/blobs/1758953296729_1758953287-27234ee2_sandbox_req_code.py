...
dot = Graph(comment='USDA Agency Structure', engine='dot')
...
# Render the graph
dot.render('usda_agency_structure', format='png', cleanup=True)
print("Graph has been generated as 'usda_agency_structure.png'")